...
class ProbeFactory:
    ...
    The six supported probe types have different physical makeups, but from the software's some are
    ...
    Methods:
        ...
        # _pacl_ea() - returns settings and subcomponents for EnergyAnalyzer objects
