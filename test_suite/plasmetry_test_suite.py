...
if __name__ == "__main__":  # execute path hammer if this script is run directly
    path_hammer(1, ['plasmetry', 'src'], ['__pycache__'], suffix='/src')  # hammer subdirs in plasmetry/src
    path_hammer(1, ['plasmetry', 'test_suite'], ['__pycache__'], suffix='/test_suite')  # hammer subdirs in plasmetry/test_suite
# ----- END PATH HAMMER ----- #
